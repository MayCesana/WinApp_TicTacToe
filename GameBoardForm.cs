...
namespace FormUI
{
    public class GameBoardForm : Form
    {
        ...
        private readonly int r_ButtonSize = 100;
        private readonly int r_SpaceBetweenButtons = 16;
        ...
        {
            int space = r_SpaceBetweenButtons;
            int buttonSize = r_ButtonSize;
            int boardSize = i_GameRoundRef.Board.Size;

            m_ButtonsMatrix = new Button[boardSize, boardSize];
            ...
            for (int i = 1; i <= boardSize; i++)
            {
                for (int j = 1; j <= boardSize; j++)
                {
                    ...
                    m_ButtonsMatrix[i - 1, j - 1] = button;
        ...
        {
            foreach(Button b in m_ButtonsMatrix)
            {
                b.Text = "";
                b.Enabled = true;
            }
